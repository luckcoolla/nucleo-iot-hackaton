 ...
 */
public class LoginActivity extends OrientationBlockActivity {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                DataService.getInstance().login(mUserName, mPassword);
                ArrayList<Board> boards = DataService.getInstance().boards();
                if (boards == null) {
    ...
    public void loginComplete() {
        if (checkPlayServices(this)) {
            final String topic = "/topics/iot_"+DataService.getInstance().getUserName();
            Log.d(TAG, "loginComplete(), subscribeToTopic: " + topic);
        ...
        intent.setClass(this, BoardListActivity.class);
        startActivity(intent);
    }

    public static boolean checkPlayServices(Context context) {
        //FIXME to check google apis with firebase import
//        GoogleApiAvailability apiAvailability = GoogleApiAvailability.getInstance();
//        int resultCode = apiAvailability.isGooglePlayServicesAvailable(context);
//        if (resultCode != ConnectionResult.SUCCESS) {
//            Log.i(TAG, "ConnectionResult is not success; " +
//                    "GoogleApiAvailability.isGooglePlayServicesAvailable(..) = " + resultCode);
//            return false;
//        }
        return true;
    }

...
/**
 * An activity representing a single Board detail screen. This
...
public class BoardDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(BoardDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(BoardDetailFragment.ARG_ITEM_ID));
            BoardDetailFragment fragment = new BoardDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.board_detail_container, fragment)
                    .commit();
        }
    }
